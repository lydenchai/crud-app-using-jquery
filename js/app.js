$(function () {
    $('#btnAdd').on('click', function () {
        ...
        var edit = "<i class='fa fa-pencil edit' style='font-size:18px; color: rgb(31, 171, 247)' href='JavaScript:void(0);' ></>";
        var del = "<i class='fa fa-trash delete' style='font-size:18px; color: rgb(243, 59, 59)' href='JavaScript:void(0);'></i>";
